...
describe("chat apiMessages", () => {
  ...
  it("prefers visible message content", () => {
    ...
    assert.match(content, /\[ChatHTML internal artifact context artifact-[a-z0-9]+\]/);
  });
  ...
  it("uses persisted artifact context before rebuilding from raw html", () => {
    ...
    assert.match(content, /\[ChatHTML internal artifact context artifact-fixed\]/);
