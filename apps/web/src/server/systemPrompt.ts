...
- If the first retrieval does not provide verified media matching an explicit user preference, make one focused follow-up retrieval that combines the exact primary subject with that preference. Never satisfy the preference by dropping or replacing the primary subject.
